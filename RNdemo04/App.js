	...
	navigationOptions: ({navigation}) => ({
		...
		headerLeft: (
			<TouchableOpacity onPress={() => {navigation.goBack()}}>
				<View style={{backgroundColor:'#ff0',marginRight:0,paddingRight:0}}>
					<Image style={{width: D(48),height: D(48),padding:D(40)}} source={require('./src/img/back.png')}/>
				</View>
			</TouchableOpacity>
		),
		headerRight:<View style={{backgroundColor:'#f0f'}}><Text>headerRight</Text></View>,
...
const Root = connect(state => ({}))(RootStack);
