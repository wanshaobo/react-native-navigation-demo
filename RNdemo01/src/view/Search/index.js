...
const SearchStackNavigator = StackNavigator(Routes,{
	initialRouteName: 'Search',//设置默认的页面组件，必须是上面已注册的页面组件
	...
	navigationOptions: ({navigation}) => ({
		...
		headerLeft: (
			<TouchableOpacity onPress={() => {navigation.goBack()}}>
				<View style={{}}>
					<Image style={{width: D(48),height: D(48),padding:D(40)}} source={require('../../img/back.png')}/>
				</View>
			</TouchableOpacity>
		),
